...
/// <summary>
/// 게임 객체의 크기(스케일)를 시간에 따라 애니메이션하는 구조체입니다.
/// 선형 보간(Lerp)을 사용하여 부드러운 크기 변화 효과를 만듭니다.
/// NaN 값을 사용하여 특정 축만 선택적으로 애니메이션할 수 있습니다.
/// </summary>
struct AstrumScaleAnimator : public AstrumAnimator {
public:
	/// <summary>
	/// 목표 크기 벡터로 스케일 애니메이터를 생성합니다.
	/// </summary>
	/// <param name="targetScale">도달할 목표 크기입니다.</param>
	...
	/// <summary>
	/// 개별 축 크기로 스케일 애니메이터를 생성합니다.
	/// </summary>
	/// <param name="animationTime">애니메이션 지속 시간(초)입니다.</param>
	/// <param name="targetX">목표 X축 크기입니다. NaN이면 X축은 애니메이션하지 않습니다.</param>
	/// <param name="targetY">목표 Y축 크기입니다. NaN이면 Y축은 애니메이션하지 않습니다.</param>
	/// <param name="targetZ">목표 Z축 크기입니다. NaN이면 Z축은 애니메이션하지 않습니다.</param>
...
public:
	/// <summary>
	/// 목표 크기로 스케일 애니메이터의 공유 포인터를 생성합니다.
	/// NaN 값을 사용하여 특정 축만 애니메이션할 수 있습니다.
	/// </summary>
	/// <param name="targetScale">도달할 목표 크기입니다.</param>
	/// <param name="animationTime">애니메이션 지속 시간(초)입니다.</param>
	/// <returns>새로 생성된 AstrumScaleAnimator 공유 포인터입니다.</returns>
	...
	/// <summary>
	/// 개별 축 크기로 스케일 애니메이터의 공유 포인터를 생성합니다.
	/// NaN 값을 사용하여 특정 축만 애니메이션할 수 있습니다.
	/// </summary>
	/// <param name="animationTime">애니메이션 지속 시간(초)입니다.</param>
	/// <param name="targetX">목표 X축 크기입니다. NaN이면 X축은 애니메이션하지 않습니다.</param>
