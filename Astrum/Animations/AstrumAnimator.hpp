...
namespace Astrum {
	...
	public:
		Animator(float animationTime);
		
		std::function<void()> OnAnimationEnding = nullptr;
		// 애니메이션 함수. (입력값은 0.0 ~ 1.0 사이), AnimationFunctions 클래스에서 다양한 애니메이션 함수를 제공합니다
		...
		virtual void SetOwner(IObject* obj) override;
		...
		virtual AnimatingStatusType GetStatus() const override;
	...
	protected:
		...
		AnimatingStatusType status = AnimatingStatusType::AnimatingStatusType_Wait;
