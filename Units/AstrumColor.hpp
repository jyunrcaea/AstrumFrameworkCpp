...
// === 청록 계열 ===
inline constexpr AstrumColor AstrumColor::Cyan = AstrumColor(0.0f, 1.0f, 1.0f);
inline constexpr AstrumColor AstrumColor::Teal = AstrumColor(0.0f, 0.502f, 0.502f);
inline constexpr AstrumColor AstrumColor::Turquoise = AstrumColor(0.251f, 0.878f, 0.816f);
inline constexpr AstrumColor AstrumColor::LightSeaGreen = AstrumColor(0.125f, 0.698f, 0.667f);
inline constexpr AstrumColor AstrumColor::Aquamarine = AstrumColor(0.498f, 1.0f, 0.831f);
inline constexpr AstrumColor AstrumColor::MediumTurquoise = AstrumColor(0.282f, 0.82f, 0.8f);
inline constexpr AstrumColor AstrumColor::PaleTurquoise = AstrumColor(0.686f, 0.933f, 0.933f);
inline constexpr AstrumColor AstrumColor::DarkCyan = AstrumColor(0.0f, 0.545f, 0.545f);

// === 초록 계열 ===
inline constexpr AstrumColor AstrumColor::Lime = AstrumColor(0.0f, 1.0f, 0.0f);
inline constexpr AstrumColor AstrumColor::PureGreen = AstrumColor(0.0f, 0.502f, 0.0f);
inline constexpr AstrumColor AstrumColor::ForestGreen = AstrumColor(0.133f, 0.545f, 0.133f);
inline constexpr AstrumColor AstrumColor::DarkGreen = AstrumColor(0.0f, 0.392f, 0.0f);
inline constexpr AstrumColor AstrumColor::MintGreen = AstrumColor(0.596f, 1.0f, 0.596f);

// === 연두 계열 ===
inline constexpr AstrumColor AstrumColor::YellowGreen = AstrumColor(0.604f, 0.804f, 0.196f);
inline constexpr AstrumColor AstrumColor::GreenYellow = AstrumColor(0.678f, 1.0f, 0.184f);
inline constexpr AstrumColor AstrumColor::Chartreuse = AstrumColor(0.498f, 1.0f, 0.0f);
inline constexpr AstrumColor AstrumColor::GrassGreen = AstrumColor(0.459f, 0.651f, 0.290f);
inline constexpr AstrumColor AstrumColor::YellowishGreen = AstrumColor(0.627f, 0.69f, 0.212f);

// === 노랑 계열 ===
inline constexpr AstrumColor AstrumColor::Yellow = AstrumColor(1.0f, 1.0f, 0.0f);
inline constexpr AstrumColor AstrumColor::Turbo = AstrumColor(1.0f, 0.8f, 0.129f);
inline constexpr AstrumColor AstrumColor::MoonYellow = AstrumColor(0.941f, 0.769f, 0.125f);
inline constexpr AstrumColor AstrumColor::VividYellow = AstrumColor(1.0f, 0.89f, 0.008f);
inline constexpr AstrumColor AstrumColor::GoldenYellow = AstrumColor(1.0f, 0.549f, 0.0f);
inline constexpr AstrumColor AstrumColor::Lemon = AstrumColor(1.0f, 0.973f, 0.0f);
inline constexpr AstrumColor AstrumColor::Mustard = AstrumColor(1.0f, 0.859f, 0.345f);

// === 주황 계열 ===
inline constexpr AstrumColor AstrumColor::Orange = AstrumColor(1.0f, 0.498f, 0.0f);
inline constexpr AstrumColor AstrumColor::DarkOrange = AstrumColor(1.0f, 0.549f, 0.0f);
inline constexpr AstrumColor AstrumColor::Coral = AstrumColor(1.0f, 0.498f, 0.314f);
inline constexpr AstrumColor AstrumColor::Tomato = AstrumColor(1.0f, 0.388f, 0.278f);
inline constexpr AstrumColor AstrumColor::Peach = AstrumColor(1.0f, 0.855f, 0.725f);

// === 빨강 계열 ===
inline constexpr AstrumColor AstrumColor::PureRed = AstrumColor(1.0f, 0.0f, 0.0f);
inline constexpr AstrumColor AstrumColor::DarkRed = AstrumColor(0.545f, 0.0f, 0.0f);
inline constexpr AstrumColor AstrumColor::Crimson = AstrumColor(0.863f, 0.078f, 0.235f);
inline constexpr AstrumColor AstrumColor::Firebrick = AstrumColor(0.698f, 0.133f, 0.133f);
inline constexpr AstrumColor AstrumColor::Scarlet = AstrumColor(1.0f, 0.141f, 0.0f);

// === 갈색 계열 ===
inline constexpr AstrumColor AstrumColor::Brown = AstrumColor(0.647f, 0.165f, 0.165f);
inline constexpr AstrumColor AstrumColor::SaddleBrown = AstrumColor(0.545f, 0.271f, 0.075f);
inline constexpr AstrumColor AstrumColor::Sienna = AstrumColor(0.627f, 0.322f, 0.176f);
inline constexpr AstrumColor AstrumColor::Chocolate = AstrumColor(0.824f, 0.412f, 0.118f);
inline constexpr AstrumColor AstrumColor::Peru = AstrumColor(0.804f, 0.522f, 0.247f);
inline constexpr AstrumColor AstrumColor::Tan = AstrumColor(0.824f, 0.706f, 0.549f);

// === 분홍 계열 ===
inline constexpr AstrumColor AstrumColor::Pink = AstrumColor(1.0f, 0.753f, 0.796f);
inline constexpr AstrumColor AstrumColor::LightPink = AstrumColor(1.0f, 0.714f, 0.757f);
inline constexpr AstrumColor AstrumColor::HotPink = AstrumColor(1.0f, 0.412f, 0.706f);
inline constexpr AstrumColor AstrumColor::DeepPink = AstrumColor(1.0f, 0.078f, 0.576f);
inline constexpr AstrumColor AstrumColor::PaleVioletRed = AstrumColor(0.859f, 0.439f, 0.576f);