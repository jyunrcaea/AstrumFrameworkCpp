...
void AstrumMatrix::Scaling(const AstrumObservedVector3& v) { Scaling(v.GetX(), v.GetY(), v.GetZ()); }
void AstrumMatrix::Rotation(const AstrumObservedVector3& v) { Rotation(v.GetX(), v.GetY(), v.GetZ()); }
void AstrumMatrix::Translation(const AstrumObservedVector3& v) { Translation(v.GetX(),v.GetY(),v.GetZ()); }
