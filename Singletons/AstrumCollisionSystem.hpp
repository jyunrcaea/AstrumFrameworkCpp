...
public:
	inline static bool IsOverlapAABBToAABB(IAstrumAABBColliderComponent* aAABB, IAstrumAABBColliderComponent* bAABB) { return AstrumCollisionSystemSingleton::Instance().IsOverlapAABBToAABB(aAABB, bAABB);}
	inline static bool IsOverlapCircleToCircle(IAstrumCircleColliderComponent* aCircle, IAstrumCircleColliderComponent* bCircle) { return AstrumCollisionSystemSingleton::Instance().IsOverlapCircleToCircle(aCircle, bCircle); }
	inline static bool IsOverlapAABBToCircle(IAstrumAABBColliderComponent* aAABB, IAstrumCircleColliderComponent* bCircle) { return AstrumCollisionSystemSingleton::Instance().IsOverlapAABBToCircle(aAABB, bCircle); }
	inline static bool IsOverlapAABBToOBB(IAstrumAABBColliderComponent* aAABB, IAstrumOBBColliderComponent* bOBB) { return AstrumCollisionSystemSingleton::Instance().IsOverlapAABBToOBB(aAABB, bOBB); }
	inline static bool IsOverlapCircleToOBB(IAstrumCircleColliderComponent* aCircle, IAstrumOBBColliderComponent* bOBB) { return AstrumCollisionSystemSingleton::Instance().IsOverlapCircleToOBB(aCircle, bOBB); }
	inline static bool IsOverlapOBBToOBB(IAstrumOBBColliderComponent* aOBB, IAstrumOBBColliderComponent* bOBB) { return AstrumCollisionSystemSingleton::Instance().IsOverlapOBBToOBB(aOBB, bOBB); }
};