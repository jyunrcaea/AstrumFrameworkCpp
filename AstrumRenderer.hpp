...
public:
    ...
    std::shared_ptr<struct IAstrumShaderPipeline> DefaultShapeShaderPipeline = nullptr;
    std::shared_ptr<struct IAstrumShaderPipeline> DefaultTextureShaderPipeline = nullptr;
